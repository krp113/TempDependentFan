...
I2C_Setup
    ...
    bcf	    TRISC, RC4	; only the data line is receiving input from the thermometer. So the data line is TRISC, RC3 = 1, and RC4 is output!!
    ...
    movlw   b'00000001'	; set up bit for SSP1CON2
